...
const SHOTS = [
  { url: msg470.url, note: "otro divorcio fallide" },
  { url: msg471.url, note: "tremenda bala esquivaste" },
  { url: msg472.url, note: "aguanta como que energía mental" },
  { url: msg473.url, note: "te quiero muchísimo maría" },
  { url: msg474.url, note: "soy madre" },
  { url: msg476.url, note: "lo que necesitas es un toddy" },
];
